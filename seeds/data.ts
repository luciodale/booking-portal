...
import type { Feature } from "../src/modules/constants";
...
The pool area is a great place to relax. It features a saltwater infinity pool, plenty of space for loungers, a large lounge area, and a pool house with a bedroom, bathroom, and kitchen.`,
    ...
    amenities: [
      ...
      { name: "saltwater-pool", icon: "waves" },
      { name: "pool-house", icon: "waves" },
      { name: "spa", icon: "sparkles" },
      { name: "sauna", icon: "flame" },
      { name: "fitness-room", icon: "dumbbell" },
      { name: "wine-cellar", icon: "wine" },
      { name: "elevator", icon: "arrow-up-down" },
      { name: "underground-parking", icon: "car" },
      { name: "rooftop", icon: "mountain" },
      { name: "drone-landing-pad", icon: "check" },
      { name: "sea-views", icon: "waves" },
      { name: "mountain-views", icon: "mountain" },
      { name: "alarm-system", icon: "shield-check" },
      { name: "cameras", icon: "shield-check" },
      { name: "underfloor-heating", icon: "thermometer" },
      { name: "air-conditioning", icon: "snowflake" },
      { name: "double-glazing", icon: "check" },
      { name: "schuco-windows", icon: "check" },
      { name: "wifi", icon: "wifi" },
      { name: "beach-access", icon: "umbrella" },
    ],
    views: [
      { name: "bay-of-palma", icon: "waves" },
      { name: "tramuntana-mountains", icon: "mountain" },
      { name: "mediterranean-sea", icon: "waves" },
    ],
    highlights: [
      { name: "sea-view", icon: "waves" },
      { name: "private-pool", icon: "waves" },
      { name: "spa-and-fitness", icon: "sparkles" },
      { name: "wine-cellar", icon: "wine" },
      { name: "energy-certificate-a", icon: "check" },
    ],
    additionalCosts: [
...
There is WIFI TV in the whole house with Netflix, Amazon Prime and Apple TV+. The property offers covered parking for 2 cars and 3 outside parking spaces.`,
    ...
    amenities: [
      { name: "sauna", icon: "flame" },
      { name: "2-living-rooms", icon: "check" },
      { name: "2-dining-rooms", icon: "check" },
      { name: "2-kitchens", icon: "utensils-crossed" },
      { name: "reading-lounge", icon: "check" },
      { name: "2-terraces", icon: "fence" },
      { name: "mountain-views", icon: "mountain" },
      { name: "sunny-hillside-location", icon: "sun" },
      { name: "wifi-tv", icon: "tv" },
      { name: "netflix", icon: "tv" },
      { name: "amazon-prime", icon: "tv" },
      { name: "apple-tv+", icon: "tv" },
      { name: "covered-parking", icon: "car" },
      { name: "outside-parking", icon: "car" },
      { name: "guest-toilet", icon: "check" },
      { name: "wef-access", icon: "check" },
    ],
    views: [
      { name: "mountain-views", icon: "mountain" },
      { name: "alpine-peaks", icon: "mountain" },
      { name: "valley-views", icon: "mountain" },
    ],
    highlights: [
      { name: "mountain-chic", icon: "mountain" },
      { name: "3-min-to-wef", icon: "check" },
      { name: "sauna", icon: "flame" },
...
This modern apartment features a fully equipped kitchen, comfortable bedrooms, and a sunny balcony overlooking the vibrant neighborhood.`,
    ...
    highlights: [
      ...
      { name: "local-shops", icon: "shopping-bag" },
    ],
    additionalCosts: [
...
The property features lush gardens, a private dock, and interiors designed by a renowned Milanese architect. Every room opens to panoramic lake views through floor-to-ceiling windows.`,
    ...
    sqMeters: 600,
    amenities: [
      { name: "private-dock", icon: "check" },
      { name: "lake-views", icon: "waves" },
      { name: "garden", icon: "flower-2" },
      { name: "wine-cellar", icon: "wine" },
      { name: "heated-pool", icon: "thermometer" },
      { name: "wifi", icon: "wifi" },
      { name: "air-conditioning", icon: "snowflake" },
    ...
    views: [
      { name: "lake-como", icon: "waves" },
      { name: "italian-alps", icon: "mountain" },
      { name: "garden", icon: "flower-2" },
    ],
    highlights: [
...
Steps from Fado houses and the iconic Tram 28 route. Rooftop terrace with sweeping views over the Tagus River.`,
    ...
    amenities: [
      { name: "wifi", icon: "wifi" },
      { name: "kitchen", icon: "utensils-crossed" },
      { name: "rooftop-terrace", icon: "fence" },
      { name: "air-conditioning", icon: "snowflake" },
      { name: "washing-machine", icon: "alarm-smoke" },
    ],
    views: [
      { name: "tagus-river", icon: "waves" },
      { name: "city-views", icon: "landmark" },
    ],
    highlights: [
      { name: "historic-district", icon: "landmark" },
      { name: "rooftop-terrace", icon: "fence" },
      { name: "river-views", icon: "waves" },
    ],
    additionalCosts: [
...
Hand-crafted timber interiors, a private outdoor hot tub, and ski-in/ski-out access make this the ultimate mountain retreat. The lodge includes a cinema room and a wellness area with sauna and steam bath.`,
    ...
    views: [
      ...
      { name: "alpine-peaks", icon: "mountain" },
      { name: "village-views", icon: "landmark" },
    ],
    highlights: [
      { name: "matterhorn-view", icon: "mountain" },
      { name: "ski-in/ski-out", icon: "snowflake" },
      { name: "hot-tub", icon: "waves" },
      { name: "cinema", icon: "tv" },
    ],
...
Enjoy the morning light flooding through large French windows while sipping coffee on the balcony overlooking the Mediterranean.`,
    ...
    views: [
      { name: "mediterranean-sea", icon: "waves" },
      { name: "promenade", icon: "check" },
    ],
    highlights: [
      { name: "seafront", icon: "waves" },
      { name: "beach-access", icon: "umbrella" },
      { name: "french-riviera", icon: "check" },
    ],
    additionalCosts: [
...
Traditional Cycladic architecture meets contemporary luxury, with a private chef kitchen, outdoor dining terraces, and direct path to a secluded cove.`,
    ...
    amenities: [
      { name: "infinity-pool", icon: "waves" },
      { name: "private-cove-access", icon: "waves" },
      { name: "chef-kitchen", icon: "chef-hat" },
      { name: "outdoor-dining", icon: "utensils-crossed" },
      { name: "air-conditioning", icon: "snowflake" },
      { name: "wifi", icon: "wifi" },
      { name: "parking", icon: "car" },
      { name: "bbq", icon: "beef" },
    ...
    views: [
      { name: "aegean-sea", icon: "waves" },
      { name: "sunset-views", icon: "sun" },
      { name: "island-panorama", icon: "eye" },
    ],
    highlights: [
      { name: "infinity-pool", icon: "waves" },
      { name: "private-cove", icon: "waves" },
      { name: "sunset-views", icon: "sun" },
      { name: "chef-kitchen", icon: "chef-hat" },
    ],
    additionalCosts: [
...
High ceilings, original parquet floors, and curated period furniture blend seamlessly with modern comforts. The fully equipped kitchenette and marble bathroom make it ideal for couples or solo travelers.`,
    ...
    amenities: [
      { name: "wifi", icon: "wifi" },
      { name: "kitchenette", icon: "utensils-crossed" },
      { name: "air-conditioning", icon: "snowflake" },
      { name: "elevator", icon: "arrow-up-down" },
      { name: "washing-machine", icon: "alarm-smoke" },
    ],
    views: [
      { name: "ringstrasse", icon: "landmark" },
      { name: "city-views", icon: "landmark" },
    ],
    highlights: [
      { name: "historic-center", icon: "landmark" },
      { name: "opera-district", icon: "music" },
      { name: "art-nouveau", icon: "palette" },
    ],
    additionalCosts: [
...
The ground floor features an open-plan living area with exposed stone walls; the upper floor houses two cozy bedrooms tucked under original timber beams.`,
    ...
    views: [
      { name: "douro-river", icon: "waves" },
      { name: "dom-luis-bridge", icon: "landmark" },
    ],
    highlights: [
      { name: "unesco-district", icon: "landmark" },
      { name: "river-views", icon: "waves" },
      { name: "historic-charm", icon: "landmark" },
    ],
    additionalCosts: [
...
Walking distance to the English Garden and excellent public transport connections to Marienplatz and the city center.`,
    ...
    views: [{ name: "courtyard", icon: "flower-2" }],
    highlights: [
      { name: "english-garden", icon: "flower-2" },
