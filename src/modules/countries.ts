/**
 * Country list keyed by ISO 3166-1 alpha-2 code.
 * English display names used throughout the app.
 */
...
/** Sorted display names for dropdown */
export const COUNTRY_NAMES = Object.values(COUNTRY_MAP).sort((a, b) =>
  a.localeCompare(b)
);
...
/** Check if a country name corresponds to Italy */
export function isItalyCountry(country: string | null | undefined): boolean {
