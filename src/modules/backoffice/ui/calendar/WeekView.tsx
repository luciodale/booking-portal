...
import { formatPriceShort, getEffectivePriceForDate, getWeekDays } from "./utils";
    ...
    <div className="bg-secondary/30 rounded-xl p-5 border border-border">
      ...
      <div className="grid grid-cols-7 gap-2">
        {weekDays.map((day, i) => {
          ...
          const dayPrice = getEffectivePriceForDate(day, existingPeriods, basePrice);
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center p-4 rounded-xl ${baseClass}`}
            >
