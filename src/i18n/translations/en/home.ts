export const home = {
  ...
  "home.ctaDescription":
    "Join our network of elite property managers and reach high-net-worth travelers directly.",
  "home.becomeHost": "Become a Host",
  "home.learnMore": "Learn More",
  "home.pageTitle": "Home",
  "home.defaultDescription":
    "Discover extraordinary places to stay. Direct access to the world's most exclusive properties.",
} as const;
