/**
 * Smoobu Apartments API Proxy
 * Proxies requests to Smoobu API using stored API key
 */
...
// ============================================================================
// GET - List all apartments for the broker
// ============================================================================
...
export const GET: APIRoute = async ({ locals }) => {
  try {
    ...
    if (!response.ok) {
      ...
      return jsonError(
        error.detail || "Failed to fetch apartments from Smoobu",
        response.status
      );
    }
    ...
    console.error("Error fetching Smoobu apartments:", error);
    return jsonError(
      error instanceof Error ? error.message : "Failed to fetch apartments"
    );
  }
};
